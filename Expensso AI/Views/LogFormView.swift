...
//  Expensso AI
//
//  Created by Ebenezer Tseh on 8/8/24.
//
...
struct LogFormView: View {
    ...
    private var formView: some View
    {
        Form {
            ...
            TextField("Amount", value: $vm.amount,
                      formatter: vm.numberFormatter)
            ...
            Picker(selection: $vm.category, label: Text("Category")) {
                ForEach(Category.allCases) {
                    category
                    in Text(category.rawValue.capitalized).tag(category)
                }
            }
